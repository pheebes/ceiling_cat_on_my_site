...
class AlgorithmsControllerTest < ActionController::TestCase
  ...
  test "should create algorithm" do
    assert_difference('Algorithm.count') do
      post :create, algorithm: { category: @algorithm.category, description: @algorithm.description, name: @algorithm.name }
    end
  ...
  test "should update algorithm" do
    patch :update, id: @algorithm, algorithm: { category: @algorithm.category, description: @algorithm.description, name: @algorithm.name }
    assert_redirected_to algorithm_path(assigns(:algorithm))
  end
